...
<a href="index.php?page=tambah-admin">Tambah Admin</a><br />
<table border="1" align="center">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="index.php?page=edit-admin&id_admin=<?php echo $row_index['id_admin']; ?>">Edit</a> |<a href="index.php?page=hapus-admin&id_admin=<?php echo $row_index['id_admin']; ?>">Hapus</a></td>
    </tr>
