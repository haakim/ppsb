...
<body>
<a href="index.php?page=tambah-pengumuman">Tambah Pengumuman </a>
<table border="1" width="100%">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><p><a href="index.php?page=edit-pengumuman&id_pengumuman=<?php echo $row_halaman_utama['id_pengumuman']; ?>">edit</a></p>
